...
const mountainSubstr = mountain.slice(6, 12);
...
const capitalizedTitle = songTitle.charAt(0).toUpperCase() + songTitle.slice(1,7) + songTitle.slice(7,11) + songTitle.charAt(11).toUpperCase() + songTitle.slice(12,18); // attento forse ci sara' da fare un fix e ovviamente un aggiunta
